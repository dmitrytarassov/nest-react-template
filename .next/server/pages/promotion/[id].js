...
/* harmony import */ var _frontend_components_ProductInfo_ProductInfo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6258);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_frontend_components_ProductInfo_ProductInfo__WEBPACK_IMPORTED_MODULE_6__]);
_frontend_components_ProductInfo_ProductInfo__WEBPACK_IMPORTED_MODULE_6__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const StyledPageMainColumnContainer = styled_components__WEBPACK_IMPORTED_MODULE_7___default()(_frontend_components_PageMainColumnContainer__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z).withConfig({
    componentId: "sc-1e6a4b30-0"
})``;
const PromotionPage = ({ rental: rental1 , promotion  })=>{
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(StyledPageMainColumnContainer, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_frontend_components_ListTop__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
                ...
                image: (0,_frontend_utils_imageUrl__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z)(rental1.icon)
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_frontend_components_ProductInfo_ProductInfo__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
                rental: rental1,
                product: _product
            })
        ]
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PromotionPage);
...
/* harmony import */ var _frontend_components_pages_promotion_PromotionPage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2949);
/* harmony import */ var _frontend_utils_clearify__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1517);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_frontend_components_pages_promotion_PromotionPage__WEBPACK_IMPORTED_MODULE_4__]);
_frontend_components_pages_promotion_PromotionPage__WEBPACK_IMPORTED_MODULE_4__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const loadData = async (promotionUrl)=>{
    const promotion = await (0,_frontend_utils_loaders__WEBPACK_IMPORTED_MODULE_2__/* .loadPromotion */ ._G)(promotionUrl);
    if (promotion) {
        const rental = await (0,_frontend_utils_loaders__WEBPACK_IMPORTED_MODULE_2__/* .loadRentalById */ .Wh)(promotion.rentalId);
        if (rental) {
            return {
                rental,
                promotion
...
const RentalProductPage = ({ rental , promotion ,  })=>{
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_frontend_components_pages_promotion_PromotionPage__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
        rental: _rental,
...
async function getServerSideProps(context) {
    try {
        const [promotionUrl] = context.req.originalUrl.split("/").reverse().map((e)=>e.split(".")[0]
        );
...
var __webpack_exports__ = __webpack_require__.X(0, [892,97,577,994,238,523,588,289], () => (__webpack_exec__(597)));
