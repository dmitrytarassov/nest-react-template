...
const RentalPromotionsPage = ({ promotions }) => {
    ...
    (0, react_1.useEffect)(() => {
        (0, updateMapRentals_1.updateMapRentals)([], '');
    }, []);
    ...
    const news = promotions
        ...
        ? true
        : e.name.toLowerCase().includes(searchString.toLowerCase()));
    return ((0, jsx_runtime_1.jsxs)(PageMainColumnContainer_1.default, { children: [(0, jsx_runtime_1.jsx)(ListTop_1.default, { breadcrumbs: breadcrumbs, backLink: `/`, title: `Акции и новинки`, search: { value: searchString, onChange: setSearchString } }), (0, jsx_runtime_1.jsx)(NewsAndPromotions_1.default, { news: news, promotions: actions })] }));
};
